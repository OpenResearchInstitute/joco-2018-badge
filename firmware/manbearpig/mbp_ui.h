...
extern void mbp_ui_input(char *p_title, char *p_label, char *p_input, uint8_t max_chars);
//extern void mbp_ui_input_box(int16_t x, int16_t y, uint8_t w, char *p_text, uint8_t max_chars);
